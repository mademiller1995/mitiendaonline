...
<!--modificar producto-->
<form action="modprod-proceso1.php" method="POST" enctype="multipart/form-data"><br>
	<center><h3>Modificar Producto</h3><br>
		<td>Id Producto: <input type="text" name="id" placholder="Id usuario"></td><br><br>
		<td>Nombre Producto: <input type="text" name="nombre" placholder="nombre"></td><br><br>
		<td>Marca: <input type="text" name="marca" placholder="apple.."></td><br><br>
		<td>Promoción: <input type="text" name="promocion" placholder="activo o no activo.."></td><br><br>
		<td>Capacidad: <input type="text" name="capacidad" placholder="16GB..."></td><br><br>
		<td>Color: <input type="text" name="color" placholder="correo"></td><br><br>
		<td>Sistema Operativo: <input type="text" name="sistemaoperativo" placholder="ios.."></td><br><br>
		<td>Descripcion: <input type="text" name="descripcion" placholder="este movil es.."></td><br><br>
		<td>Precio: <input type="number" name="precio" placholder="50.00"></td><br><br>
		<td>Moneda: <input type="text" name="moneda" placholder="euros"></td><br><br>
